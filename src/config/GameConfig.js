...
export const GameConfig = {
  ...
  WEAPON_3D: {
    ...
    GUNS: {
      pistol: {
        BASE_POSITION: [0.14,  -0.14,  -0.33],
        BASE_ROTATION_Y: -0.08,
        ADS_OFFSET: [-0.12,  0.06,  -0.08],
        ADS_ROTATION: -0.02,
        SCALE: 3.0,
      },
      shotgun: {
        BASE_POSITION: [0.17,  -0.18,  -0.34],
        BASE_ROTATION_Y: -0.09,
        ADS_OFFSET: [-0.15,  0.08,  -0.07],
        ADS_ROTATION: -0.03,
        SCALE: 3.0,
      },
      rifle: {
        BASE_POSITION: [0.19,  -0.155, -0.34],
        BASE_ROTATION_Y: -0.09,
        ADS_OFFSET: [-0.19,  0.08,  -0.09],
        ADS_ROTATION: 0.00,
        SCALE: 3.0,
      },
      smg: {
        BASE_POSITION: [0.13,  -0.14,  -0.30],
        BASE_ROTATION_Y: -0.08,
        ADS_OFFSET: [-0.11,  0.07,  -0.08],
        ADS_ROTATION: -0.02,
        SCALE: 3.0,
      },
      sniper: {
        BASE_POSITION: [0.22,  -0.16,  -0.38],
        BASE_ROTATION_Y: -0.09,
        ADS_OFFSET: [-0.22,  0.09,  -0.10],
        ADS_ROTATION: 0.00,
        SCALE: 3.0,
      },
      grenade_launcher: {
        BASE_POSITION: [0.18,  -0.18,  -0.36],
        BASE_ROTATION_Y: -0.09,
        ADS_OFFSET: [-0.16,  0.08,  -0.09],
        ADS_ROTATION: -0.02,
        SCALE: 3.0,
      },
      plasma: {
        BASE_POSITION: [0.15,  -0.145, -0.32],
        BASE_ROTATION_Y: -0.08,
        ADS_OFFSET: [-0.14,  0.07,  -0.08],
        ADS_ROTATION: -0.02,
        SCALE: 3.0,
      },
    },
