...
export class Pistol extends Weapon {
  ...
  buildModel({ addBox, addCyl, mat }) {
    addBox(0.072, 0.052, 0.310, mat.metal,  0,        0.006,  -0.018);
    ...
    addBox(0.062, 0.036, 0.260, mat.dark,   0,       -0.034,  -0.005);
    addBox(0.060, 0.024, 0.044, mat.dark,   0,       -0.034,  -0.140);
    ...
    addBox(0.058, 0.116, 0.090, mat.rubber, 0,       -0.111,   0.091,  0.20);
    addBox(0.052, 0.008, 0.072, mat.metal,  0,       -0.172,   0.086,  0.20);
